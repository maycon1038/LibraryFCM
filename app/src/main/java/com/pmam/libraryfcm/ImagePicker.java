...
public class ImagePicker {
	...
	public static Intent getPickImageIntent(Context context, String Provider) {
		...
		Uri contentUri = getUriForFile(context, Provider, getTempFile(context));
	...
	public static Bitmap getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
		...
		if (resultCode == SecurityBaseActivity.RESULT_OK) {
			Uri selectedImage;
